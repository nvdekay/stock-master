...
function ManagerSidebar({ isCollapsed, setIsCollapsed }) {
    ...
    const menuItems = [
        ...
        { icon: 'fas fa-box', label: 'Quản lý sản phẩm', path: '/manager/products' },
        { icon: 'fas fa-clipboard-list', label: 'Quản lý tồn kho', path: '/manager/inventory' },
        { icon: 'fas fa-users', label: 'Quản lý nhân viên', path: '/manager/staffs' }
    ];
                ...
                >
                    <div className="p-4">
                        <div className="d-flex justify-content-between align-items-center mb-4">
                            <h5 className="text-muted mb-0">MANAGER</h5>
                            <button
